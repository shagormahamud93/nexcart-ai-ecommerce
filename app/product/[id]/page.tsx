          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <button
                ...
                className="flex-1 flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 cursor-pointer"
              >
              ...
              <button
                ...
                className="p-3 border border-gray-300 dark:border-gray-800 rounded-md dark:hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 cursor-pointer"
              >
